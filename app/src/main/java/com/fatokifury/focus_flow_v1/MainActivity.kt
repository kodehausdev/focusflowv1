...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            // Example: Delete a task (if you want to test deletion)
            // allTasks?.firstOrNull()?.let { taskToDelete ->
            //     taskDao.deleteTaskById(taskToDelete.id)
            //     Log.d("RoomTest", "Deleted Task with ID: ${taskToDelete.id}")
            //     val tasksAfterDelete = taskDao.getAllTasks().firstOrNull()
            //     Log.d("RoomTest", "Tasks after delete: $tasksAfterDelete")
            // }
        }
        // --- End of Simple Room Test ---
